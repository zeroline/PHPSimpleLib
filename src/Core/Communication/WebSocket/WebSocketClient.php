...
class WebSocketClient
{
    ...
    protected static $opcodes = array(
        EnumMessageType::CONTINUOUS     => 0,
        EnumMessageType::TEXT           => 1,
        EnumMessageType::BINARY         => 2,
        EnumMessageType::CLOSE          => 8,
        EnumMessageType::PING           => 9,
        EnumMessageType::PONG           => 10,
    );
    ...
    public function send($payload, $opcode = EnumMessageType::TEXT, $masked = true)
    {
        ...
        while ($payload_length > $fragment_cursor) {
          ...
          // all fragments after the first will be marked a continuation
            $opcode = EnumMessageType::CONTINUOUS;
        }
    }
    ...
    protected function receiveFragment()
    {
        ...
        if ($opcode !== EnumMessageType::CONTINUOUS) {
        ...
        if ($opcode === EnumMessageType::CLOSE) {
